...
var messages = {
  ...
  homeWelcome: 'Welcome on vStorage!',
  homeWelcomeText: 'Add your vGate hosts or pools',
  homeConnectServerText: 'Some vGates have been registered but are not connected',
  ...
  jobActionPlaceHolder: 'Select a vStorage-server API command',
  ...
  tipLabel: 'Tip:',
  tipConsoleLabel: 'Due to a vGate issue, non-US keyboard layouts aren\'t well supported. Switch your own layout to US to workaround it.',
  ...
  xsTasks: 'Currently, there are not any pending vGate tasks',
  ...
  existingSrModalText: 'This path has been previously used as a Storage by a vGate host. All data will be lost if you choose to continue the SR creation.',
  existingLunModalTitle: 'Previous LUN Usage',
  existingLunModalText: 'This LUN has been previously used as a Storage by a vGate host. All data will be lost if you choose to continue the SR creation.',
  alreadyRegisteredModal: 'Replace current registration?',
  alreadyRegisteredModalText: 'Your VS appliance is already registered to {email}, do you want to forget and replace this registration ?',
  trialReadyModal: 'Ready for trial?',
  trialReadyModalText: 'During the trial period, VSA need to have a working internet connection. This limitation does not apply for our paid plans!',
  ...
  xenOrchestraServer: 'vStorage server',
  xenOrchestraWeb: 'vStorage web client',
  ...
  xoAccount: 'Access your VS Account',
  ...
  trialLocked: 'Your vsa-updater service appears to be down. Your VSA cannot run fully without reaching this service.',
  noUpdateInfo: 'No update information available',
  waitingUpdateInfo: 'Update information may be available',
  upToDate: 'Your VSA is up-to-date',
  mustUpgrade: 'You need to update your VSA (new version is available)',
  registerNeeded: 'Your VSA is not registered for updates',
  updaterError: 'Can\'t fetch update information',
  promptUpgradeReloadTitle: 'Upgrade successful',
  promptUpgradeReloadMessage: 'Your VSA has successfully upgraded, and your browser must reload the application. Do you want to reload now ?',

  // ----- OS Disclaimer -----
  disclaimerTitle: 'vStorage from the sources',
  disclaimerText1: 'You are using VS from the sources! That\'s great for a personal/non-profit usage.',
  ...
  xosanNeedPack: 'VSSAN pack needs to be installed on each host of the pool.',
  xosanInstallIt: 'Install it now!',
  xosanNeedRestart: 'Some hosts need their toolstack to be restarted before you can create an VSSAN',
  xosanRestartAgents: 'Restart toolstacks',
  xosanMasterOffline: 'Pool master is not running',
  xosanInstallPackTitle: 'Install VSSAN pack on {pool}',
  ...
  xosanCreate: 'Create',
  xosanInstalling: 'Installing VSSAN. Please wait...',
  xosanCommunity: 'No VSSAN available for Community Edition',
  // Pack download modal
  xosanInstallCloudPlugin: 'Install cloud plugin first',
  xosanLoadCloudPlugin: 'Load cloud plugin first',
  xosanLoading: 'Loading...',
  xosanNotAvailable: 'VSSAN is not available at the moment',
  xosanRegisterBeta: 'Register for the VSSAN beta',
  xosanSuccessfullyRegistered: 'You have successfully registered for the VSSAN beta. Please wait until your request has been approved.',
