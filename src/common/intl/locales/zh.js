...
export default {
  ...
  serverUnauthorizedCertificates: '未经授权的证书',
  serverAllowUnauthorizedCertificates: '允许未经授权的证书',
  serverStatus: '状态',
  settingsLogsPage: '日志',
  settingsIpsPage: 'IPs',
  settingsConfigPage: '配置',
  vdisOnControlDomain: '控制域上的VDI',
  recomputeResourceSets: '重新计算所有限制',
  backupOwner: '备份所有者',
  jobTimeoutPlaceHolder: ' 超时 (虚拟机被认为失败的秒数)',
  schedulingEveryNMonth: '每N个月',
  homeSortByType: '类型',
  jobType: '类型',
  serverPlaceHolderUser: '用户名',
  serverPlaceHolderPassword: '密码',
  serverPlaceHolderAddress: '地址[:端口]',
  serverPlaceHolderLabel: '标签',
  genericCancel: '取消',
  jobTimezone: '时区',
  logDeleteAll: '删除所有日志',
  logDeleteAllTitle: '删除所有日志',
  logUser: '用户',
  logMethod: '方法',
  logParams: '参数',
  logMessage: '信息',
  logError: '错误',
  logDisplayDetails: '显示详细信息',
  logTime: '日期',
  noConfigFile: '没有选择配置文件',
  importTip: '尝试在此放置配置文件，或单击以选择要上传的配置文件。',
  config: '配置',
  importConfig: '导入',
  importConfigSuccess: '配置文件导入成功',
  importConfigError: '导入配置文件时发生错误',
  exportConfig: '导出',
  downloadConfig: '下载当前配置',
  noConfigImportCommunity: '社区版本的vStorage没有可导入的配置文件',
  homeTypeVmTemplate: '模板',
  schedulingEachSelectedDay: '每个选定日',
  schedulingEveryNDay: '每N天',
  schedulingDay: '天',
  selectTableAllMonth: '每月',
  selectTableAllDay: '每天',
  selectTableAllHour: '每小时',
  selectTableAllMinute: '每分钟',
  editBackupDepthTitle: '保留的份数',
  editBackupTagTitle: '标签',
  newBackupSelection: '选择备份的类型:',
  smartBackupModeSelection: '选择备份的模式:',
  normalBackup: '正常备份',
  smartBackup: '智能备份',
  localRemoteWarningTitle: '已选位于本机的远程文件系统',
  localRemoteWarningMessage: '警告: 位于本机的备份空间大小受vStorage磁盘空间的限制，这一功能只用于高级用户.',
  backupVersionWarning: '警告: 这个功能需要vGate 5.2.1或之后版本支持 ',
  editBackupVmsTitle: '虚拟机',
  editBackupSmartStatusTitle: '虚拟机状态',
  editBackupSmartResidentOn: '所在主机',
  editBackupSmartPools: '资源池',
  editBackupSmartTags: '标签',
  editBackupSmartTagsTitle: '虚拟机标签',
  editBackupNot: '相反',
  editBackupReportTitle: '报告',
  editBackupScheduleEnabled: '按计划自动运行',
  editBackupRemoteTitle: '备份到',
  deleteOldBackupsFirst: '先删除旧备份',
  vmsToBackup: '备份的虚拟机',
  vmMemory: '内存',
  ...
  vmImportConfigAlert: '请检查或修改虚拟机配置.',
  noPlugins: '没有发现插件',
  noControlDomainVdis: '没有VDI附加到控制域',
  newVmAdvancedPanel: '高级',
  newVmShowAdvanced: '显示高级设置',
  newVmHideAdvanced: '隐藏高级设置',
  jobSchedules: '任务日程',
  supplementalPacks: '安装补充包',
  supplementalPackNew: '安装新的补充包',
  supplementalPackPoolNew: '在每个主机上安装补充包',
  supplementalPackTitle: '{name} (by {author})',
  supplementalPackInstallStartedTitle: '安装已开始',
  supplementalPackInstallStartedMessage: '正在安装补充包',
  supplementalPackInstallErrorTitle: '安装错误',
  supplementalPackInstallErrorMessage: '补充包安装失败',
