...
const LOG_COLUMNS = [
  ...
  {
    name: _('jobStart'),
    itemRenderer: log => log.start && <FormattedDate value={new Date(log.start)} month='short' day='numeric' year='numeric' hour='2-digit' minute='2-digit' second='2-digit' hour12={false} />,
  ...
  },
  {
    default: true,
    name: _('jobEnd'),
    itemRenderer: log => log.end && <FormattedDate value={new Date(log.end)} month='short' day='numeric' year='numeric' hour='2-digit' minute='2-digit' second='2-digit' hour12={false} />,
